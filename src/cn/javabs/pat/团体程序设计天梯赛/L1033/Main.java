package cn.javabs.pat.团体程序设计天梯赛.L1033;
 ...
 * //Mr.yang注: 如果需要写入很多次而只读取一次, 应使用 LinkedHashSet (LinkedList, LinkedMap 这种 Link 开头的表示里面是一个链表)
 * //Mr.yang注: 有关多写少读, 多读少写, 多读多写, 差异性数据, 同质化数据, 海量数据索引等等问题详见 数据结构概论
 */
public class Main {
