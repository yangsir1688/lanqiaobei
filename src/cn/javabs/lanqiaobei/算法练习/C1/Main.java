package cn.javabs.lanqiaobei.算法练习.C1;
 ...
 * Arrays库好用得一匹= =！ //Mr.yang注: 类似的工具类还有 Collections
 * 今天这个题有点顶不住，要做的小模块有点多，看来低估题目难度了，明天得加一把劲
 * 有时候思路太乱，直接删干净写过的题目也是个办法  //Mr.yang注: 重构
 */
public class Main {
    ...
    //Mr.yang注: 注意 IDEA 给出的代码修正提示
    //Mr.yang注: 方法名应当使用小驼峰, 例如 splitArray(尽可能不要使用缩写以提升代码可读性)
